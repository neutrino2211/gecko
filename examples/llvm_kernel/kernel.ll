...
@.str.d18213ca26a0654893fc7b010aafdf1b = private global [50 x i8] c"  _____ ______ _____ _  ______     ____   _____ \0A\00"
@.str.2f67c533a492d8ca11aeb501137cd4f5 = private global [50 x i8] c" / ____|  ____/ ____| |/ / __ \5C   / __ \5C / ____|\0A\00"
@.str.452fe04b476b31a41a07630479afce6b = private global [50 x i8] c"| |  __| |__ | |    | ' / |  | | | |  | | (___  \0A\00"
@.str.026a703ff16938ba122a5ab444b61e33 = private global [50 x i8] c"| | |_ |  __|| |    |  <| |  | | | |  | |\5C___ \5C \0A\00"
@.str.b5599d9f5a96ade4cf4432d7963af871 = private global [50 x i8] c"| |__| | |___| |____| . \5C |__| | | |__| |____) |\0A\00"
@.str.e41c5507ad2a7019b10da9d2814a0065 = private global [50 x i8] c" \5C_____|______\5C_____|_|\5C_\5C____/   \5C____/|_____/ \0A\00"
@.str.7910220523f052509812a36c7905f9d3 = private global [2 x i8] c"\0A\00"
@.str.90df44ce2a6c5cae49b719eabaae82a3 = private global [63 x i8] c"LLVM Gecko OS v0.1 - A kernel written in Gecko (LLVM Backend)\0A\00"
@.str.10a1b038b1b3d7e2150dfc3212ef44c2 = private global [38 x i8] c"Type 'help' for available commands.\0A\0A\00"
@.str.37f674888cc686a3b3a1e1e509c556a9 = private global [6 x i8] c"gecko\00"
@.str.6309f5d9361bb5cf885702039bc4efc1 = private global [3 x i8] c"> \00"
@.str.228324eb205234f77a2be09ccfc3f340 = private global [5 x i8] c"help\00"
@.str.235956a424a6254c73c1b915b8e84c41 = private global [6 x i8] c"clear\00"
@.str.1e8e8bea9eb711bfcc0c574faef0aa3a = private global [6 x i8] c"about\00"
@.str.de01a7c6fa61695764b3607fb16ddec8 = private global [5 x i8] c"echo\00"
@.str.8764414ed9e0bd5cc71e68b6f6559456 = private global [6 x i8] c"color\00"
@.str.66d049c22b89254134f6185263ba0b4e = private global [7 x i8] c"reboot\00"
@.str.d2ce8c5dbf4d170e26dd4b62c456a6f3 = private global [5 x i8] c"halt\00"
@.str.27a85f320e7835a596ccb8532bce67b7 = private global [18 x i8] c"Unknown command: \00"
@.str.0ff20e694a9e4e2cb16857ce92a03a73 = private global [2 x i8] c"\0A\00"
@.str.3e1e825cca55f22c1c760bf77be3807e = private global [21 x i8] c"Available commands:\0A\00"
@.str.52a36c4093048e9d497b1b7a7262c565 = private global [35 x i8] c"  help   - Show this help message\0A\00"
@.str.8ba9d78aabaa9f434639c65a3b030ff9 = private global [29 x i8] c"  clear  - Clear the screen\0A\00"
@.str.ee7cebc87a0922bfc52a6d47f3856dc6 = private global [27 x i8] c"  about  - About Gecko OS\0A\00"
@.str.31b14e2502c2590dad6f0704ec965a08 = private global [27 x i8] c"  echo   - Echo text back\0A\00"
@.str.24a8d68e00c8889642cee4bf6411a690 = private global [30 x i8] c"  color  - Change text color\0A\00"
@.str.16ba7ab76827eecfb91df29514696dc0 = private global [30 x i8] c"  reboot - Reboot the system\0A\00"
@.str.de13f3dd27f3bf298d94b21fa9276542 = private global [25 x i8] c"  halt   - Halt the CPU\0A\00"
@.str.ba9f4abed0fdf5cd6f8f9bbbf17382fa = private global [16 x i8] c"\0AGecko OS v0.1\0A\00"
@.str.f2909e7036b2451c6a9076325af8a685 = private global [46 x i8] c"A minimal kernel written entirely in Gecko.\0A\0A\00"
@.str.46fbc473ab111ff9b6e59386a741404d = private global [11 x i8] c"Features:\0A\00"
@.str.b8aaa3be8f3560bf26c2f115b50652b6 = private global [42 x i8] c"  - VGA text mode console with scrolling\0A\00"
@.str.d56e9b94263b1ee660e3ab332a7a73d3 = private global [35 x i8] c"  - PS/2 keyboard input (polling)\0A\00"
@.str.22586023d95704039919eef02307210a = private global [27 x i8] c"  - Simple command shell\0A\0A\00"
@.str.889a7dc8f239908783a7972ac7506df9 = private global [13 x i8] c"Built with:\0A\00"
@.str.c1f31755887d67b265f6eb802994c189 = private global [32 x i8] c"  - Gecko programming language\0A\00"
@.str.3c8c4192dddabdf7e57a9159fb2e0115 = private global [33 x i8] c"  - LLVM Backend (llc + ld.lld)\0A\00"
@.str.9a3f04d978904c5326419b5ccc059aea = private global [21 x i8] c"  - Module imports\0A\0A\00"
@.str.1e4f82974c3118567eed7d0d4904197d = private global [21 x i8] c"Color set to green!\0A\00"
@.str.873894021c55a119213175b958f6cf9a = private global [14 x i8] c"Rebooting...\0A\00"
@.str.bd699caaa85368fc4f2a9deff61f7da5 = private global [23 x i8] c"Halting CPU. Goodbye!\0A\00"
@llvm.used = appending global [1 x i8*] [i8* bitcast (void ()* @kmain to i8*)], section "llvm.metadata"

define void @outb(i16 %port, i8 %value) {
outb$main:
	store i16 %port, i16* @io_port
	store i8 %value, i8* @io_byte
	call void asm sideeffect "movw io_port, %dx; movb io_byte, %al; outb %al, %dx", ""()
	ret void
}

define i8 @inb(i16 %port) {
inb$main:
	store i16 %port, i16* @io_port
	call void asm sideeffect "movw io_port, %dx; inb %dx, %al; movb %al, io_byte", ""()
...
define i8 @scancode_to_char(i8 %scancode) {
scancode_to_char$main:
	%0 = load i8, i8* @KEY_RELEASED
	%1 = icmp uge i8 %scancode, %0
...
shell__Shell__print_banner$main:
	...
	%4 = getelementptr [50 x i8], [50 x i8]* @.str.d18213ca26a0654893fc7b010aafdf1b, i8 0
	...
	%7 = getelementptr [50 x i8], [50 x i8]* @.str.2f67c533a492d8ca11aeb501137cd4f5, i8 0
	...
	%10 = getelementptr [50 x i8], [50 x i8]* @.str.452fe04b476b31a41a07630479afce6b, i8 0
	...
	%13 = getelementptr [50 x i8], [50 x i8]* @.str.026a703ff16938ba122a5ab444b61e33, i8 0
	...
	%16 = getelementptr [50 x i8], [50 x i8]* @.str.b5599d9f5a96ade4cf4432d7963af871, i8 0
	...
	%19 = getelementptr [50 x i8], [50 x i8]* @.str.e41c5507ad2a7019b10da9d2814a0065, i8 0
	...
	%22 = getelementptr [2 x i8], [2 x i8]* @.str.7910220523f052509812a36c7905f9d3, i8 0
	...
	%28 = getelementptr [63 x i8], [63 x i8]* @.str.90df44ce2a6c5cae49b719eabaae82a3, i8 0
	...
	%31 = getelementptr [38 x i8], [38 x i8]* @.str.10a1b038b1b3d7e2150dfc3212ef44c2, i8 0
...
shell__Shell__print_prompt$main:
	...
	call void @console__Console__set_color(%Console* %0, i8 %1, i8 %2)
	%3 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%4 = getelementptr [6 x i8], [6 x i8]* @.str.37f674888cc686a3b3a1e1e509c556a9, i8 0
	...
	%9 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%10 = getelementptr [3 x i8], [3 x i8]* @.str.6309f5d9361bb5cf885702039bc4efc1, i8 0
...
if.merge.70:
	%3 = getelementptr [5 x i8], [5 x i8]* @.str.228324eb205234f77a2be09ccfc3f340, i8 0
...
if.else.71:
	%5 = getelementptr [6 x i8], [6 x i8]* @.str.235956a424a6254c73c1b915b8e84c41, i8 0
...
elseif.else.72:
	%7 = getelementptr [6 x i8], [6 x i8]* @.str.1e8e8bea9eb711bfcc0c574faef0aa3a, i8 0
...
elseif.else.73:
	%9 = getelementptr [5 x i8], [5 x i8]* @.str.de01a7c6fa61695764b3607fb16ddec8, i8 0
...
elseif.else.74:
	%11 = getelementptr [6 x i8], [6 x i8]* @.str.8764414ed9e0bd5cc71e68b6f6559456, i8 0
...
elseif.else.75:
	%13 = getelementptr [7 x i8], [7 x i8]* @.str.66d049c22b89254134f6185263ba0b4e, i8 0
...
elseif.else.76:
	%15 = getelementptr [5 x i8], [5 x i8]* @.str.d2ce8c5dbf4d170e26dd4b62c456a6f3, i8 0
...
elseif.else.77:
	...
	%21 = getelementptr [18 x i8], [18 x i8]* @.str.27a85f320e7835a596ccb8532bce67b7, i8 0
	...
	%30 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%31 = getelementptr [2 x i8], [2 x i8]* @.str.0ff20e694a9e4e2cb16857ce92a03a73, i8 0
...
shell__Shell__cmd_help$main:
	...
	call void @console__Console__set_color(%Console* %0, i8 %1, i8 %2)
	%3 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%4 = getelementptr [21 x i8], [21 x i8]* @.str.3e1e825cca55f22c1c760bf77be3807e, i8 0
	...
	call void @console__Console__set_color(%Console* %6, i8 %7, i8 %8)
	%9 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%10 = getelementptr [35 x i8], [35 x i8]* @.str.52a36c4093048e9d497b1b7a7262c565, i8 0
	%11 = bitcast [35 x i8]* %10 to i8*
	call void @console__Console__print_str(%Console* %9, i8* %11)
	%12 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%13 = getelementptr [29 x i8], [29 x i8]* @.str.8ba9d78aabaa9f434639c65a3b030ff9, i8 0
	%14 = bitcast [29 x i8]* %13 to i8*
	call void @console__Console__print_str(%Console* %12, i8* %14)
	%15 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%16 = getelementptr [27 x i8], [27 x i8]* @.str.ee7cebc87a0922bfc52a6d47f3856dc6, i8 0
	%17 = bitcast [27 x i8]* %16 to i8*
	call void @console__Console__print_str(%Console* %15, i8* %17)
	%18 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%19 = getelementptr [27 x i8], [27 x i8]* @.str.31b14e2502c2590dad6f0704ec965a08, i8 0
	%20 = bitcast [27 x i8]* %19 to i8*
	call void @console__Console__print_str(%Console* %18, i8* %20)
	%21 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%22 = getelementptr [30 x i8], [30 x i8]* @.str.24a8d68e00c8889642cee4bf6411a690, i8 0
	%23 = bitcast [30 x i8]* %22 to i8*
	call void @console__Console__print_str(%Console* %21, i8* %23)
	%24 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%25 = getelementptr [30 x i8], [30 x i8]* @.str.16ba7ab76827eecfb91df29514696dc0, i8 0
	%26 = bitcast [30 x i8]* %25 to i8*
	call void @console__Console__print_str(%Console* %24, i8* %26)
	%27 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%28 = getelementptr [25 x i8], [25 x i8]* @.str.de13f3dd27f3bf298d94b21fa9276542, i8 0
...
shell__Shell__cmd_about$main:
	...
	call void @console__Console__set_color(%Console* %0, i8 %1, i8 %2)
	%3 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%4 = getelementptr [16 x i8], [16 x i8]* @.str.ba9f4abed0fdf5cd6f8f9bbbf17382fa, i8 0
	...
	call void @console__Console__set_color(%Console* %6, i8 %7, i8 %8)
	%9 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%10 = getelementptr [46 x i8], [46 x i8]* @.str.f2909e7036b2451c6a9076325af8a685, i8 0
	%11 = bitcast [46 x i8]* %10 to i8*
	call void @console__Console__print_str(%Console* %9, i8* %11)
	%12 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%13 = getelementptr [11 x i8], [11 x i8]* @.str.46fbc473ab111ff9b6e59386a741404d, i8 0
	%14 = bitcast [11 x i8]* %13 to i8*
	call void @console__Console__print_str(%Console* %12, i8* %14)
	%15 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%16 = getelementptr [42 x i8], [42 x i8]* @.str.b8aaa3be8f3560bf26c2f115b50652b6, i8 0
	%17 = bitcast [42 x i8]* %16 to i8*
	call void @console__Console__print_str(%Console* %15, i8* %17)
	%18 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%19 = getelementptr [35 x i8], [35 x i8]* @.str.d56e9b94263b1ee660e3ab332a7a73d3, i8 0
	%20 = bitcast [35 x i8]* %19 to i8*
	call void @console__Console__print_str(%Console* %18, i8* %20)
	%21 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%22 = getelementptr [27 x i8], [27 x i8]* @.str.22586023d95704039919eef02307210a, i8 0
	%23 = bitcast [27 x i8]* %22 to i8*
	call void @console__Console__print_str(%Console* %21, i8* %23)
	%24 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%25 = getelementptr [13 x i8], [13 x i8]* @.str.889a7dc8f239908783a7972ac7506df9, i8 0
	%26 = bitcast [13 x i8]* %25 to i8*
	call void @console__Console__print_str(%Console* %24, i8* %26)
	%27 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%28 = getelementptr [32 x i8], [32 x i8]* @.str.c1f31755887d67b265f6eb802994c189, i8 0
	%29 = bitcast [32 x i8]* %28 to i8*
	call void @console__Console__print_str(%Console* %27, i8* %29)
	%30 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%31 = getelementptr [33 x i8], [33 x i8]* @.str.3c8c4192dddabdf7e57a9159fb2e0115, i8 0
	%32 = bitcast [33 x i8]* %31 to i8*
	call void @console__Console__print_str(%Console* %30, i8* %32)
	%33 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%34 = getelementptr [21 x i8], [21 x i8]* @.str.9a3f04d978904c5326419b5ccc059aea, i8 0
...
shell__Shell__cmd_color$main:
	...
	call void @console__Console__set_color(%Console* %0, i8 %1, i8 %2)
	%3 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%4 = getelementptr [21 x i8], [21 x i8]* @.str.1e4f82974c3118567eed7d0d4904197d, i8 0
	%5 = bitcast [21 x i8]* %4 to i8*
	call void @console__Console__print_str(%Console* %3, i8* %5)
	ret void
}
...
shell__Shell__cmd_reboot$main:
	%0 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%1 = getelementptr [14 x i8], [14 x i8]* @.str.873894021c55a119213175b958f6cf9a, i8 0
...
shell__Shell__cmd_halt$main:
	%0 = getelementptr %Shell, %Shell* %self, i32 0, i32 0
	%1 = getelementptr [23 x i8], [23 x i8]* @.str.bd699caaa85368fc4f2a9deff61f7da5, i8 0
...
define void @disable_interrupts() {
disable_interrupts$main:
	call void asm sideeffect "cli", ""()
	ret void
}

define void @enable_interrupts() {
enable_interrupts$main:
	call void asm sideeffect "sti", ""()
	ret void
}

define void @hang() noreturn {
hang$main:
	call void @disable_interrupts()
	br label %loop.header.83

loop.header.83:
	br i1 true, label %loop.body.83, label %loop.exit.83
...
kmain$main:
	call void @disable_interrupts()
	%0 = call %Console @console__Console__new()
	%con = alloca %Console
	store %Console %0, %Console* %con
	%1 = load i8, i8* @LIGHT_GRAY
	%2 = load i8, i8* @BLACK
	call void @console__Console__set_color(%Console* %con, i8 %1, i8 %2)
	call void @console__Console__clear(%Console* %con)
	%3 = load %Console, %Console* %con
	%4 = call %Shell @shell__Shell__new(%Console %3)
	%sh = alloca %Shell
	store %Shell %4, %Shell* %sh
	call void @shell__Shell__run(%Shell* %sh)
	call void @hang()
	ret void
}
